...
class TestNormalize:
    ...
    def test_fixes_curly_double_quotes(self):
        assert normalize("“hello”") == '"hello"'

    def test_fixes_d_hook_to_d(self):
...
class TestStripAccents:
    ...
    def test_eth_to_d_via_normalize(self):
    ...
    def test_mixed_lookalikes_and_accents(self):
...
class TestLoadUVD1:
    ...
    def test_garbage_filtered(self, tmp_path: Path):
        p = tmp_path / "uvd1.txt"
...
class TestLoadAspell:
    def test_load_with_count_line(self, tmp_path: Path):
    ...
    def test_load_without_count(self, tmp_path: Path):
        p = tmp_path / "aspell.dic"
...
class TestLoadNames:
    ...
    def test_ascii_only_skipped(self, tmp_path: Path):
        p = tmp_path / "names.txt"
    ...
    def test_no_vietnamese(self, tmp_path: Path):
        p = tmp_path / "names.txt"
...
class TestMergeWords:
    ...
    def test_keeps_highest_confidence_surface(self):
        words = [
            RawWord(normalized="muỗng", surface="muỗng", no_tone="muong", source="uvd_1"),
            RawWord(
                normalized="muỗng",
    ...
    def test_different_words_stay_separate(self):
        words = [
            RawWord(normalized="muỗng", surface="muỗng", no_tone="muong", source="uvd_1"),
